...
for (x_l in c(40,50,60,70,80)){
  set.seed(seed)
  dat<-readRDS(file=paste0("/rds/user/ib401/hpc-work/dat_simsurv/dat_simsurv_",seed,".RDS"))
  m<-"SBP"
  n_row<-nrow(dat)
  ...
  saveRDS(dat_gold_F_x_l[[1]],file=paste0("/rds/project/rds-csoP2nj6Y6Y/ib401/dat_gold_F/dat_gold_F_",x_l,"/dat_gold_LOCF_F_",x_l,"_",seed,".RDS"))
}
