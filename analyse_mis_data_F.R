...
for (x_l in c(40,50,60,70,80)){
  set.seed(seed)
  dat<-readRDS(file=paste0("/rds/user/ib401/hpc-work/dat_mis_simsurv/dat_mis_simsurv_",seed,".RDS"))
  m<-"SBP"
  n_row<-nrow(dat)
  ...
  dat[[paste0("Xij_", m)]] <-
    ...
    dat[[paste0("beta_2_",m)]]*sqrt((dat[["tij_SBP"]]-dat[[paste0("tau_",m)]])^2)
  ...
  dat[[paste0("Xij_", m)]] <-
    ...
    dat[[paste0("beta_2_",m)]]*sqrt((dat[["tij_TCHDL"]]-dat[[paste0("tau_",m)]])^2)
  ...
  dat[[paste0("SBP_slope")]]<-dat[[paste0("betaLong_SBP_random_linear")]]+dat[[paste0("betaLong_SBP_fixed_linear")]]+
    +(((x_l-mean_response_time_F)/sd_response_time_F)<dat[["tau_SBP"]])*(-dat[["beta_2_SBP"]])+
    +(((x_l-mean_response_time_F)/sd_response_time_F)>dat[["tau_SBP"]])*dat[["beta_2_SBP"]]
  dat[[paste0("TCHDL_slope")]]<-dat[[paste0("betaLong_TCHDL_random_linear")]]+dat[[paste0("betaLong_TCHDL_fixed_linear")]]+
    +(((x_l-mean_response_time_F)/sd_response_time_F)<dat[["tau_TCHDL"]])*(-dat[["beta_2_TCHDL"]])+
    +(((x_l-mean_response_time_F)/sd_response_time_F)>dat[["tau_TCHDL"]])*dat[["beta_2_TCHDL"]]
  ...
  saveRDS(dat_LOCF_F_x_l[[1]]$model_survival$coef,file=paste0("/rds/project/rds-csoP2nj6Y6Y/ib401/dat_mis_LOCF_coef/dat_mis_LOCF_F_coef_",x_l,"_",obs,"_",seed,".RDS"))
  saveRDS(dat_LOCF_F_x_l[[1]]$prediction_error,file=paste0("/rds/project/rds-csoP2nj6Y6Y/ib401/dat_mis_LOCF_prediction_error/dat_mis_LOCF_F_",x_l,"_",obs,"_",seed,".RDS"))
  saveRDS(dat_LOCF_F_x_l[[1]],file=paste0("/rds/project/rds-csoP2nj6Y6Y/ib401/dat_mis_LOCF_F/dat_mis_LOCF_F_",x_l,"_",obs,"/dat_mis_LOCF_F_",x_l,"_",obs,"_",seed,".RDS"))
  rm(dat_LOCF_F_x_l)
  ...
  saveRDS(dat_gold_F_x_l[[1]]$model_survival$coef,file=paste0("/rds/project/rds-csoP2nj6Y6Y/ib401/dat_mis_gold_with_slope_coef/dat_mis_gold_F_coef_",x_l,"_",obs,"_",seed,".RDS"))
  saveRDS(dat_gold_F_x_l[[1]]$prediction_error,file=paste0("/rds/project/rds-csoP2nj6Y6Y/ib401/dat_mis_gold_with_slope_prediction_error/dat_mis_gold_F_",x_l,"_",obs,"_",seed,".RDS"))
  saveRDS(dat_gold_F_x_l[[1]],file=paste0("/rds/project/rds-csoP2nj6Y6Y/ib401/dat_mis_gold_F_with_slope/dat_mis_gold_F_",x_l,"/dat_mis_gold_F_",x_l,"_",obs,"_",seed,".RDS"))
  rm(dat_gold_F_x_l)
  ...
  saveRDS(dat_gold_F_x_l[[1]]$model_survival$coef,file=paste0("/rds/project/rds-csoP2nj6Y6Y/ib401/dat_mis_gold_coef/dat_mis_gold_F_coef_",x_l,"_",obs,"_",seed,".RDS"))
  saveRDS(dat_gold_F_x_l[[1]]$prediction_error,file=paste0("/rds/project/rds-csoP2nj6Y6Y/ib401/dat_mis_gold_prediction_error/dat_mis_gold_F_",x_l,"_",obs,"_",seed,".RDS"))
  saveRDS(dat_gold_F_x_l[[1]],file=paste0("/rds/project/rds-csoP2nj6Y6Y/ib401/dat_mis_gold_F/dat_mis_gold_F_",x_l,"/dat_mis_gold_F_",x_l,"_",obs,"_",seed,".RDS"))
  rm(dat_gold_F_x_l)
  ...
  saveRDS(dat_LME_F_x_l[[1]]$model_survival$coef,file=paste0("/rds/project/rds-csoP2nj6Y6Y/ib401/dat_mis_LME_with_slope_coef/dat_mis_LME_F_coef_",x_l,"_",obs,"_",seed,".RDS"))
  saveRDS(dat_LME_F_x_l[[1]]$prediction_error,file=paste0("/rds/project/rds-csoP2nj6Y6Y/ib401/dat_mis_LME_with_slope_prediction_error/dat_mis_LME_F_",x_l,"_",obs,"_",seed,".RDS"))
  saveRDS(dat_LME_F_x_l[[1]],file=paste0("/rds/project/rds-csoP2nj6Y6Y/ib401/dat_mis_LME_F_with_slope/dat_mis_LME_F_",x_l,"_",obs,"/dat_mis_LME_F_",x_l,"_",obs,"_",seed,".RDS"))
  rm(dat_LME_F_x_l)
  ...
  saveRDS(dat_LME_F_x_l[[1]]$model_survival$coef,file=paste0("/rds/project/rds-csoP2nj6Y6Y/ib401/dat_mis_LME_coef/dat_mis_LME_F_coef_",x_l,"_",obs,"_",seed,".RDS"))
  saveRDS(dat_LME_F_x_l[[1]]$prediction_error,file=paste0("/rds/project/rds-csoP2nj6Y6Y/ib401/dat_mis_LME_prediction_error/dat_mis_LME_F_",x_l,"_",obs,"_",seed,".RDS"))
  saveRDS(dat_LME_F_x_l[[1]],file=paste0("/rds/project/rds-csoP2nj6Y6Y/ib401/dat_mis_LME_F/dat_mis_LME_F_",x_l,"_",obs,"/dat_mis_LME_F_",x_l,"_",obs,"_",seed,".RDS"))
  rm(dat_LME_F_x_l)
}
